...
<div class="box">
  ...
  <%
    for (File file : fileItem.getFolder().listFiles()) {//show file list
  %>

  <div class="card" title="<%=file.getName()%>"
       style='background-image: none'>

    <div style="margin: auto;padding: initial">
...
<a href="<%=request.getContextPath()%>/change"><button>Change Name</button></a>
